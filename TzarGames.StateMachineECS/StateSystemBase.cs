...
{
    public abstract partial class StateSystemBase : SystemBase
    {
        ...
        public class State
        {
            ...
            public virtual void Initialize(StateSystemBase system)
            {
                System = system;
    ...
    public class StateSystem<S> : StateSystemBase where S : struct, IComponentData
    {
